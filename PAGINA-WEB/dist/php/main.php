...
<html lang="es">
    <head>
        ...
        <script defer src="../assets/js/ocultarSecciones.js"></script>
    ...
    <body>
        ...
        <aside class="sidebar">
            ...
            <ul class="menu">
                ...
                <li>
                    <details>
                        <summary><i class="fa-solid fa-cogs"></i> Registro</summary>
                        <ul class="submenu">
                            <li><a href="#" onclick="toggleVisibility(null, 'curso', 'Gestión de Cursos')">Registrar Curso</a></li>
                            <li><a href="#" onclick="toggleVisibility(null, 'docente', 'Gestión de Docentes')">Registrar Docente</a></li>
                            <li><a href="#" onclick="toggleVisibility(null, 'estudiante', 'Gestión de Estudiantes')">Registrar Estudiante</a></li>
                        </ul>
                    </details>
                </li>
